  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "blob-1": "blob-drift 20s ease-in-out infinite",
        "blob-2": "blob-drift-reverse 25s ease-in-out infinite",
        "blob-3": "blob-drift-slow 30s ease-in-out infinite",
      },
      boxShadow: {
        "soft": "0 2px 8px -2px hsl(var(--foreground) / 0.08)",
        "soft-lg": "0 8px 24px -4px hsl(var(--foreground) / 0.1)",
      },
    },
  },
